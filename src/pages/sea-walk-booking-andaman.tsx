...
const Page = () => {
	return (
		<div>
			<ArticleJsonLd
				title="Sea Walk Booking Andaman"
				description="Book Sea walk for Andaman tour with best price and options"
				url="https://example.com/sea-walk-booking-andaman"
			...
			<div>
				<div>
					<h1 style={{ textAlign: "center" }}>Sea Walk Booking Andaman</h1>
				</div>
