...
const Page = () => {
	return (
		<div>
			<ArticleJsonLd
				title="Cab Booking For Andaman Tour"
				description="Book cabs for Andaman tour with best price and options"
				url="https://example.com/cab-booking-for-andaman-tour-trips"
			...
			<div>
				<div>
					<h1 style={{ textAlign: "center" }}>Cab Booking For Andaman Tour</h1>
				</div>
