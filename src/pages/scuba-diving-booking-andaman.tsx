...
const Page = () => {
	return (
		<div>
			<ArticleJsonLd
				title="Scuba Diving Booking Andaman"
				description="Book Scuba diving for Andaman tour with best price and options"
				url="https:??example.com/scuba-diving-booking-andaman"
			...
			<div>
				<div>
					<h1 style={{ textAlign: "center" }}>Scuba Diving Booking Andaman</h1>
				</div>
