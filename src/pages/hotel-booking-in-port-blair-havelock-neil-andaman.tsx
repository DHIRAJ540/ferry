...
const Page = () => {
	return (
		<div>
			<ArticleJsonLd
				title="Hotel Booking in Port Blair – Havelock – Neil – Andaman"
				description="Book packages  in Port Blair, Havelock, Neil, Andaman with best price and options"
				url="https://example.com/hotel-booking-in-port-blair-havelock-neil-andaman"
			...
			<div>
				<div>
					<h1 style={{ textAlign: "center" }}>
						Hotel Booking in Port Blair – Havelock – Neil – Andaman
					</h1>
				</div>
